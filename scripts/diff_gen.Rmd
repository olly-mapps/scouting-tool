...
```{r}
write.csv(standard_from, "../Data/standard_from.csv")
write.csv(shooting_from, "../Data/shooting_from.csv")
write.csv(passing_from, "../Data/passing_from.csv")
write.csv(gca_from, "../Data/gca_from.csv")
write.csv(defense_from, "../Data/defense_from.csv")
write.csv(possession_from, "../Data/possession_from.csv")
write.csv(playing_time_from, "../Data/playing_time_from.csv")
write.csv(misc_from, "../Data/misc_from.csv")
write.csv(keepers_from, "../Data/keepers_from.csv")
write.csv(keepers_adv_from, "../Data/keepers_adv_from.csv")
```
...
```{r}
write.csv(standard_changes, "../Data/standard_changes.csv")
write.csv(shooting_changes, "../Data/shooting_changes.csv")
write.csv(passing_changes, "../Data/passing_changes.csv")
write.csv(gca_changes, "../Data/gca_changes.csv")
write.csv(defense_changes, "../Data/defense_changes.csv")
write.csv(possession_changes, "../Data/possession_changes.csv")
write.csv(playing_time_changes, "../Data/playing_time_changes.csv")
write.csv(misc_changes, "../Data/misc_changes.csv")
write.csv(keepers_changes, "../Data/keepers_changes.csv")
write.csv(keepers_adv_changes, "../Data/keepers_adv_changes.csv")
```
